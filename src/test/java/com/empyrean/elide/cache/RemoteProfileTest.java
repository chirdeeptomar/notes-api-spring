 ...
 * <p>
 * Booting the remote profile for real is not a useful test here: it would need a reachable
...
class RemoteProfileTest {
    ...
    @Test
    void remoteProfileSwitchesToRemote() {
        assertThat(modeDeclaredIn("application-remote.properties"))
